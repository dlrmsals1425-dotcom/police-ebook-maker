...
(function (g) {
  ...
  function bookCss() {
    return [
      ...
      ".cover-top{min-height:62dvh!important;padding:22px 20px 18px!important;flex:1.5 1 0!important;}",
      ...
      ".cover-emblem{width:72px!important;height:72px!important;margin:16px 0 14px!important;}",
