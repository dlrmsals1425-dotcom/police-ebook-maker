...
(function (g) {
  ...
  function bookCss() {
    return [
      ...
      ".ebook-page.is-open{width:100%!important;height:100%!important;max-height:100%!important;overflow:auto!important;-webkit-overflow-scrolling:touch;}",
      ...
      ".page-inner{padding:18px 16px 10px!important;overflow:visible!important;flex:0 0 auto!important;min-height:min-content!important;height:auto!important;}",
      ".page-body,.page-body .blk,.flow,.flow-step,.flow-card,.dodont,.law-card,.check-group{flex:0 0 auto!important;min-height:min-content!important;height:auto!important;overflow:visible!important;}",
      ".flow{gap:10px!important;justify-content:flex-start!important;}",
      ".flow-card{overflow:hidden!important;}",
      ".page-end{margin-top:12px!important;}",
