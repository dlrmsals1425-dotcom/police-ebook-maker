...
(function (g) {
  ...
  EB.buildSampleProject = function () {
    ...
    const p12 = page("law", "법령을 현장에 적용하는 법", {}, [
      ...
      EB.createBlock("law", {
        title: "가정폭력처벌법 — 긴급임시조치 취지",
        text: "피해자의 보호를 위해, 가해자의 접근·연락·주거 출입을 신속히 제한할 필요가 있는 경우 현장 경찰관은 긴급한 조치를 검토한다. 이 쪽은 조문의 취지를 줄인 것이며 원문 전체를 대체하지 않는다.",
        apply: "현장에서 ‘지금 이 공간에 남겨두면 추가 피해가 예상되는가’를 기준으로 본다. 피해자가 처벌을 원하지 않아도 보호 조치 검토는 별개다.",
        caution: "조문 번호와 요건은 개정될 수 있다. 실제 적용 전에는 최신 조문과 내부 매뉴얼을 확인한다. 이 책은 법령 해석의 최종 근거가 아니다.",
        original:
          "(가상 정리) 긴급임시조치는 피해자 보호를 위한 신속 조치로서, 접근 금지·전기통신 금지 등 필요한 범위를 현장에서 검토한다. 원문 전문은 법제처 또는 내부 법령집을 따른다.",
        collapsed: true
      }),
      EB.createBlock("summary", {
    ...
    const p16 = page("law", "일러두기", {}, [
      EB.createBlock("heading", { text: "이 책을 펼치기 전에", level: 2 }),
      EB.createBlock("paragraph", {
        text: "여기 실린 사례는 모두 가상이다. 실제 사건 정보와 개인정보는 담지 않았다. 현장에서는 최신 법령, 청 훈령, 서 매뉴얼이 언제나 앞선다."
      }),
      EB.createBlock("law", {
        title: "우선 확인 순서",
        text: "① 생명·안전  ② 내부 현장매뉴얼  ③ 관련 특별법 취지  ④ 일반 형법·형사소송법 원칙",
        apply: "조문을 외우기보다 ‘이 상황에서 어떤 질문을 던질 것인가’를 몸에 익힌다.",
        caution: "이 책의 문장만으로 강제수사·긴급조치의 적법성을 단정하지 않는다.",
        original: "",
        collapsed: true
      }),
      EB.createBlock("tip", {
        text: "펼치기 전에 표지의 발행 부서와 판 번호를 확인한다. 지난 판은 쓰지 않는다."
      }),
      EB.createBlock("summary", {
        text: "이 책은 판단의 출발점이다. 최종 근거는 현행 법령과 내부 매뉴얼이다."
      })
    ]);
